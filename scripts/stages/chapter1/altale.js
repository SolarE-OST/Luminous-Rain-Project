...
export default class Altale extends Stage {
    constructor() {
        super("Altale");

        // Stage-specific variables
		this.title = "Altale"; // Title of stage
		this.artist = "Sakuzyo"; // Artist of track for stage (usually Sakuzyo lol)
		this.subtitle = "Adventures Unlocked"; // Subtitle (displayed under title)
		this.songDuration = "2:33"; // Duration of song, display only
        this.difficulty = 4; // Difficulty (1-10, sometimes 11, rarely 12)
		this.tempo = 180; // Starting tempo of track (in beats per minute BPM)
		...
		this.songPath = "assets/music/chapter1/Altale.mp3"; // Music file path location

...
export default class Stage extends Phaser.Scene {
    ...
    initGUI() {
        ...
        this.guiArtist = this.glowingText(750, 80, this.artist, 20).setDepth(
            101
        );
        this.guiScoreLabel = this.glowingText(750, 150, "Score:", 36).setDepth(
            101
        );
        ...
        this.progressBar = this.add
            .rectangle(0, 0, 0, 10, 0xf0f076, 0.3)
            .setOrigin(0, 0);
    }
    ...
    initPlayer() {
        ...
        this.playerOutline = this.add.ellipse(
            300,
            400,
            13,
            13,
        ...
        this.playerCenter = this.add.ellipse(
            300,
            400,
            10,
            10,
    ...
    moveDroplets(dt = 1) {
        for (let d of this.activeDroplets) {
            ...
            if (d.setDelete) {
                ...
                this.activeDroplets = this.activeDroplets.filter(
                    (x) => x !== d
                );
            }
        }
    ...
    update() {
        ...
        if (this.waiting) {
            ...
            this.progressBar.setSize(
                (this.music.seek / this.music.totalDuration) * 600,
                10
            );
        }
        /*
